...
<html>
  <head>
    ...
    <meta charset='utf-8'>
    <title>Picking The Tees | View Request</title>
  ...
  <title>Request Maps</title>
   ...
   <section id="selector">
		<ul class='container-fluid mb-0'>
			...
			<li>|</li>
			<li><a href='#'><font color='black'>Requested Locations</font></a></li>
			<li>|</li>
   ...
   <section class="d-flex justify-content-center mt-2" id="map"></section>
		...
		var map = new google.maps.Map(document.getElementById('map'), {
			...
			for(var i in json){
			  ...
			  if(json[i].AdditionalDescription == ""){
				 contentString = "<header><h4>LOCATION REQUEST #"+ json[i].RequestID +"</h4></header><section><img src='"+ json[i].imgPath +"' width=100 height=100></ul></nav><article><p><b>Date: </b>"+ json[i].Date +"</p><p><b>Litter Scale: </b>"+ json[i].LitterScale +"</p></article></section>"
			  } else{
				 contentString = "<header><h4>LOCATION REQUEST #"+ json[i].RequestID +"</h4></header><section><img src='"+ json[i].imgPath +"' width=100 height=100></ul></nav><article><p><b>Date: </b>"+ json[i].Date +"</p><p><b>Litter Scale: </b>"+ json[i].LitterScale +"</p><p><b>Additional Description: </b>"+ json[i].AdditionalDescription +"</p></article></section>"
    ...
    <script async defer
    src='https://maps.googleapis.com/maps/api/js?key=AIzaSyB_AWzvRLQ4vJCybLAJuKZRNa8MakxV56I&callback=initMap'>
    </script>
  </body>
</html>
