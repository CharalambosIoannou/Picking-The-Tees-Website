...
<head>
    ...
    <title>Picking The Tees | Review Submissions</title>
            ...
            <ul class='navbar-nav mr-4'>
              ...
              <li class='nav-item dropdown'>
                ...
                <div class='dropdown-menu' aria-labelledby='navbarDropdown'>
                  <a class='dropdown-item active' href='#'>Litter picks</a>
 ...
 <button type='button' class='btn btn-primary'id='submitPassword'>Submit</button>
	...
	<section id='selector'>
				<ul class='container-fluid mb-0'>
					<li><a href='#'><font color='black'>Review Submissions</font></a></li>
					<li>|</li>
    ...
    <section  id='gallery'>
        ...
        <h1 class='pt-2' style='font-size: 34px'>Submissions to Review: </h1>
        <br/>

";
while($row = $result->fetch_assoc()) {
	$litter;
	$req_id=$row['SubmissionID'];
	$current_reqid;
	...
	echo "
        <div class='list-group' style='margin-left: 50px; margin-right: 50px'>
            <a class='list-group-item list-group-item-action flex-column align-items-start'>
                <div class='container' align='center'>
                    <div class='row'>
                        <div class='col-8' style='padding-right:20px; border-right: 1px solid #ccc;'>
							...
							<br>
                            Litter Collected:  ". $row['litter']."
							<br>
							Number of bags collected:  ". $row['bag']."
							<br>
							Number of hours needed:  ". $row['hour']."
							<br>
							Number of people involved:  ". $row['people']."
							<br>
			 ...
			 <form onclick='return clicked()' action='delete_sub.php' method='post' id='form_del' >
