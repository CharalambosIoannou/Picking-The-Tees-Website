...
<html>
  <head>
    ...
    <meta charset='utf-8'>
    <title>Picking The Tees | View Species</title>
  ...
  <title>Request Maps</title>
   ...
   <section id="selector">
		<ul class='container-fluid mb-0'>
			...
			<li>|</li>
            <li><a href='#'><font color='black'>Invasive Species</font></a></li>
            <li>|<li>
      ...
      function initMap() {
		...
		var map = new google.maps.Map(document.getElementById('map'), {
			...
			for(var i in json){
			  ...
			  var contentString;
			  if(json[i].AddDesc == ""){
				 contentString = "<header><h4>REPORTED INVASIVE SPECIES #"+ json[i].SpecID +"</h4></header><section><img src='"+ json[i].photoURL +"' width=100 height=100></ul></nav><article><p><b>Date: </b>"+ json[i].date +"</p><p><b>Reported Species: </b>"+ json[i].species +"</p></article></section>"
			  } else{
				 contentString = "<header><h4>REPORTED INVASIVE SPECIES #"+ json[i].SpecID +"</h4></header><section><img src='"+ json[i].photoURL +"' width=100 height=100></ul></nav><article><p><b>Date: </b>"+ json[i].date +"</p><p><b>Reported Species: </b>"+ json[i].species +"</p><p><b>Additional Description: </b>"+ json[i].addDesc +"</p></article></section>"
			  }
